...
public class SessionHandlerTest {
    ...
    void shouldReturn201ResponseWhenRequestIsValid()
        ...
        Map<String, String> expectedHeaders = Map.of("session-id", "new-session-id");
        when(mockApiGatewayProxyResponseEvent.getHeaders()).thenReturn(expectedHeaders);
        ...
        assertEquals(mockApiGatewayProxyResponseEvent.getHeaders(), expectedHeaders);
    }
