...
//        System.setProperty("EXPERIAN_API_WRAPPER_URL", "/api");
    ...
    public void shouldConvertQuestionStateToQuestionAnswerRequest(){
        ...
        when(questionStateMock.getQaPairs()).thenReturn(List.of(new QuestionAnswerPair(new Question()), new QuestionAnswerPair(new Question()) ));

        QuestionAnswerRequest questionAnswerRequestMock = experianService.prepareToSubmitAnswers(questionStateMock);
