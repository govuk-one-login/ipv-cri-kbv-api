...
import uk.gov.di.ipv.cri.kbv.api.handler.pact.states.EvidenceThinFileState;
...
public class ValidVcIssuedHandlerThinFileTest
        implements DummyStates, PersonIdentityDetailState, EvidenceThinFileState, TestFixtures {
    ...
    static void setupServer() {
        ...
        System.setProperty(
                "pact.filter.description", "Valid credential request for VC with a Thin-file");
    ...
    void pactSetup(PactVerificationContext context)
        ...
        EvidenceFactory evidenceFactory =
                new EvidenceFactory(
                        objectMapper, eventProbeMock, KBV_QUESTION_QUALITY_MAPPING_SERIALIZED);
    ...
    public void validDummyAccessToken() throws ParseException, JsonProcessingException {
        ...
        kbvItem.setQuestionState(objectMapper.writeValueAsString(new QuestionState()));
    ...
    private void setupEventProbeBehaviour() {
        ...
        when(eventProbeMock.log(any(Level.class), any(Exception.class))).thenReturn(eventProbeMock);
        doNothing()
                .when(eventProbeMock)
