...
import uk.gov.di.ipv.cri.kbv.api.handler.pact.states.EvidencePassState;
...
public class ValidVcIssuedHandlerPassTest
        implements DummyStates, PersonIdentityDetailState, EvidencePassState, TestFixtures {
    ...
    public void validDummyAccessToken() throws ParseException, JsonProcessingException {
        ...
        when(kbvStorageServiceMock.getKBVItem(sessionId))
                .thenReturn(kbvItemQuestionAskedStatesResultsSummary());
    ...
    private KBVItem kbvItemQuestionAskedStatesResultsSummary() throws JsonProcessingException {
        KBVItem kbvItem = kbvItemState3outOf3KbvCorrect();
        kbvItem.setQuestionState(objectMapper.writeValueAsString(KbvCompletedIn2Batches()));
        return kbvItem;
    }

    @NotNull
    private KBVItem kbvItemState3outOf3KbvCorrect() {
    ...
    private QuestionState KbvCompletedIn2Batches() {
