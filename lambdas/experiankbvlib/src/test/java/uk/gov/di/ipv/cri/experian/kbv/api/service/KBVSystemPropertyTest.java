...
import uk.gov.di.ipv.cri.experian.kbv.api.annotations.SystemProperties;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.mockito.Mockito.when;
import static uk.gov.di.ipv.cri.experian.kbv.api.service.KBVSystemProperty.JAVAX_NET_SSL_KEYSTORE;
import static uk.gov.di.ipv.cri.experian.kbv.api.service.KBVSystemProperty.JAVAX_NET_SSL_KEYSTORE_PASSWORD;
import static uk.gov.di.ipv.cri.experian.kbv.api.service.KBVSystemProperty.JAVAX_NET_SSL_KEYSTORE_TYPE;
