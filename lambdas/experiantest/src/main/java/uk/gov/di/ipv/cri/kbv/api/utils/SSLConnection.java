...
import uk.gov.di.ipv.cri.kbv.api.models.SSLHandshakeReport;
...
public final class SSLConnection {
    ...
    public static SSLHandshakeReport testSSLHandshake(String host, int port)
    ...
    private static SSLHandshakeReport createReport(SSLSocket socket)
            throws SSLPeerUnverifiedException {
        return new SSLHandshakeReport(socket.getSession());
    }
}
