...
public final class Bash {
    ...
    public static class CommandConfig {
        ...
        public CommandConfig(Duration timeout, Map<String, String> environment) {
            this.timeout = timeout != null ? timeout : DEFAULT_TIMEOUT;
            this.environment = environment != null ? environment : Collections.emptyMap();
        }

        public static CommandConfig defaultConfig() {
            return new CommandConfig(Duration.ofSeconds(30), null);
        }
    }

    public static String execute(String command) {
        return execute(command, CommandConfig.defaultConfig());
    }

    public static String execute(String command, CommandConfig config) {
        ...
        try {
            ...
            try (BufferedReader reader =
                ...
                boolean completed = process.waitFor(config.timeout.toSeconds(), TimeUnit.SECONDS);
